...
% Stright beams
beams = [struct('start', 'anchor 1', 'end', 'lattice 1, x=1', 't', 1.0);
         struct('start', 'anchor 2', 'end', 'lattice 2, x=1', 't', 1.0);
         struct('start', 'anchor 3', 'end', 'lattice 3, x=1', 't', 1.0);
         struct('start', 'anchor 4', 'end', 'lattice 4, x=1', 't', 1.0);
         struct('start', 'lattice 1, x=1', 'end', 'lattice 1, x=2', 't', 1.0);
         struct('start', 'lattice 2, x=1', 'end', 'lattice 2, x=2', 't', 1.0);
         struct('start', 'lattice 3, x=1', 'end', 'lattice 3, x=2', 't', 1.0);
         struct('start', 'lattice 4, x=1', 'end', 'lattice 4, x=2', 't', 1.0);
         struct('start', 'lattice 1, x=2', 'end', 'lattice 1, x=3', 't', 1.0);
         struct('start', 'lattice 2, x=2', 'end', 'lattice 2, x=3', 't', 1.0);
         struct('start', 'lattice 3, x=2', 'end', 'lattice 3, x=3', 't', 1.0);
         struct('start', 'lattice 4, x=2', 'end', 'lattice 4, x=3', 't', 1.0);
         ...
         struct('start', 'lattice 1, x=8', 'end', 'loaded point', 't', 1.0);
         struct('start', 'lattice 2, x=8', 'end', 'loaded point', 't', 1.0);
         struct('start', 'lattice 3, x=8', 'end', 'loaded point', 't', 1.0);
         struct('start', 'lattice 4, x=8', 'end', 'loaded point', 't', 1.0);
% Cross beams
         struct('start', 'anchor 1', 'end', 'lattice 3, x=1', 't', 2.0);
         struct('start', 'anchor 2', 'end', 'lattice 4, x=1', 't', 2.0);
         struct('start', 'anchor 3', 'end', 'lattice 1, x=1', 't', 2.0);
         struct('start', 'anchor 4', 'end', 'lattice 2, x=1', 't', 2.0);
         struct('start', 'lattice 1, x=1', 'end', 'lattice 3, x=2', 't', 2.0);
         struct('start', 'lattice 2, x=1', 'end', 'lattice 4, x=2', 't', 2.0);
         struct('start', 'lattice 3, x=1', 'end', 'lattice 1, x=2', 't', 2.0);
         struct('start', 'lattice 4, x=1', 'end', 'lattice 2, x=2', 't', 2.0);
